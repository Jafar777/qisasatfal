...
export default function UpdatePost() {
  ...
  const handleUpdloadImage = async () => {
    try {
      if (!file) {
        setImageUploadError('الرجاء إختيار صورة');
        return;
      }
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      <h1 className='text-center text-3xl my-7 font-semibold'>تحديث القصة</h1>
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          ...
          >
            <option id='arabic' value='uncategorized'>إختر نوع القصة</option>
        ...
        />
        <Button id='arabic' type='submit' gradientDuoTone='purpleToPink'>
          تحديث القصة
        </Button>
        {publishError && (
